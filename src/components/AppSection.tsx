...
export default function AppSection() {
    ...
    const handleAppStoreClick = () => {
        ...
        window.open("https://apps.apple.com/us/app/gogo-fuel/id6443653210", "_blank");
    };

    const handlePlayStoreClick = () => {
        trackAppDownload("android");
        window.open("https://play.google.com/store/apps/details?id=bj.gogo.customer", "_blank");
    };

    return (
        <section className="py-24 bg-white overflow-hidden" id="app">
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-3 bg-white text-slate-900 px-6 py-3.5 rounded-xl font-bold hover:bg-gray-100 transition-colors shadow-lg shadow-white/10"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center gap-3 bg-slate-800 text-white border border-slate-700 px-6 py-3.5 rounded-xl font-bold hover:bg-slate-700 transition-colors shadow-lg"
                                >
                                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="relative w-[280px] md:w-[320px] aspect-[9/19] bg-slate-800 rounded-[3rem] border-8 border-slate-900 shadow-2xl overflow-hidden">
                            ...
                            <div className="w-full h-full bg-gradient-to-b from-slate-700 to-slate-800 flex items-center justify-center">
                                <div className="text-center">
                                    <div className="w-16 h-16 bg-primary rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-lg shadow-primary/20">
                                        <Truck className="w-8 h-8 text-black" />
                                    </div>
                                    <p className="text-white font-bold text-xl">GoGo</p>
                                    <p className="text-slate-400 text-sm mt-1">
                                        {isFr ? "Énergie Livrée" : "Energy Delivered"}
                                    </p>

                                    <button className="mt-8 bg-black/40 backdrop-blur-md text-white px-6 py-2 rounded-full text-sm font-medium border border-white/10">
                            ...
                            <div className="absolute bottom-0 inset-x-0 bg-white p-6 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.2)]">
                                ...
                                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                                    <div className="w-2/3 h-full bg-accent rounded-full animate-pulse"></div>
                                </div>
                            </div>
                        </div>
                    </div>
